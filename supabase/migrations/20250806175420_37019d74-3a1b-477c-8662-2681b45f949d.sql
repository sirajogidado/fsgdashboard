...
-- Create AOC certificates table first
...
CREATE POLICY "Authenticated users can view aop licenses" ON public.aop_licenses FOR SELECT USING (true);
CREATE POLICY "Technical and Super users can modify aop licenses" ON public.aop_licenses FOR ALL USING (true);
